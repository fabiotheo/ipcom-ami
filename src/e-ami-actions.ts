...
import type { I_CoreShowChannel, I_CoreShowChannelsComplete } from './interfaces/core-interface.js';
import type { I_DualHangup, I_Hangup, I_HangupRequest } from './interfaces/hangup.interface.js';
  ...
  public BridgeInfo(options: I_ActionBridgeInfo): Promise<I_BridgeInfoChannel> {
    return new Promise<I_BridgeInfoChannel>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionBridgeInfo, I_Response>(options);
  ...
  public BridgeList(options: I_ActionBridgeList): Promise<I_BridgeListItem[]> {
    return new Promise<I_BridgeListItem[]>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionBridgeList, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
  ...
  public CoreShowChannels(options: I_ActionCoreShowChannels): Promise<I_CoreShowChannel[]> {
    return new Promise<I_CoreShowChannel[]>((resolve, reject) => {
      (async () => {
        ...
        const onCORE_SHOW_CHANNEL_COMPLETE = (response: I_CoreShowChannelsComplete) => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionCoreShowChannels, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
  ...
  public Hangup(options: I_ActionHangup): Promise<I_DualHangup> {
    return new Promise<I_DualHangup>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionHangup, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListeners();
          }
  ...
  public Login(options: I_ActionLogin): Promise<boolean> {
    return new Promise<boolean>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionLogin, I_Response>(options);
  ...
  public Originate(options: I_ActionOriginate): Promise<boolean> {
    return new Promise<boolean>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionOriginate, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
  ...
  public QueueMemberAdd(options: I_ActionQueueAdd): Promise<I_QueueMemberAdded> {
    return new Promise<I_QueueMemberAdded>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionQueueAdd, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
  ...
  public QueueMemberRemove(options: I_ActionQueueRemove): Promise<I_QueueMemberRemoved> {
    return new Promise<I_QueueMemberRemoved>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionQueueRemove, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            removeListener();
            reject(response);
          }
  ...
  public QueueMemberPenalty(options: I_ActionQueuePenalty): Promise<I_QueueMemberPenalty> {
    return new Promise<I_QueueMemberPenalty>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionQueuePenalty, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
  ...
  public QueueMemberPause(options: I_ActionQueuePause): Promise<I_QueueMemberPause> {
    return new Promise<I_QueueMemberPause>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionQueuePause, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
    ...
    return new Promise<I_QueueMember[]>((resolve, reject) => {
      (async () => {
        ...
        try {
          ...
          if (options.MembersCount !== undefined && options.MembersCount !== null) {
            countMembers =
              countMembers === options.MembersCount ? countMembers : options.MembersCount;
          } else {
          ...
          const response = await this.eAmi.action<I_ActionQueueStatus, I_QueueParams>(options);
  ...
  public QueueSummary(options: I_ActionQueueSummary): Promise<I_QueueSummary> {
    return new Promise<I_QueueSummary>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionQueueSummary, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
  ...
  public Status(options: I_ActionStatus): Promise<I_Status> {
    return new Promise<I_Status>((resolve, reject) => {
      (async () => {
        ...
        try {
          const response = await this.eAmi.action<I_ActionStatus, I_Response>(options);
          if (response?.Response?.toLowerCase() === 'error') {
            reject(response);
            removeListener();
          }
