...
export function isAuthMethodNotAllowed(evt: AMIEvent): evt is AuthMethodNotAllowed {
...
export function isBridgeVideoSourceUpdate(evt: AMIEvent): evt is BridgeVideoSourceUpdate {
...
export function isChallengeResponseFailed(evt: AMIEvent): evt is ChallengeResponseFailed {
...
export function isChannelTalkingStart(evt: AMIEvent): evt is ChannelTalkingStart {
...
export function isConfbridgeListRooms(evt: AMIEvent): evt is ConfbridgeListRooms {
...
export function isConfbridgeStopRecord(evt: AMIEvent): evt is ConfbridgeStopRecord {
...
export function isContactListComplete(evt: AMIEvent): evt is ContactListComplete {
...
export function isContactStatusDetail(evt: AMIEvent): evt is ContactStatusDetail {
...
export function isCoreShowChannelMapComplete(evt: AMIEvent): evt is CoreShowChannelMapComplete {
  return evt.Event === 'CoreShowChannelMapComplete';
}

export function isCoreShowChannelsComplete(evt: AMIEvent): evt is CoreShowChannelsComplete {
...
export function isDeviceStateListComplete(evt: AMIEvent): evt is DeviceStateListComplete {
...
export function isEndpointDetailComplete(evt: AMIEvent): evt is EndpointDetailComplete {
...
export function isEndpointListComplete(evt: AMIEvent): evt is EndpointListComplete {
  return evt.Event === 'EndpointListComplete';
}

export function isExtensionStateListComplete(evt: AMIEvent): evt is ExtensionStateListComplete {
...
export function isFAXSessionsComplete(evt: AMIEvent): evt is FAXSessionsComplete {
...
export function isLocalOptimizationBegin(evt: AMIEvent): evt is LocalOptimizationBegin {
  return evt.Event === 'LocalOptimizationBegin';
}

export function isLocalOptimizationEnd(evt: AMIEvent): evt is LocalOptimizationEnd {
...
export function isPresenceStateChange(evt: AMIEvent): evt is PresenceStateChange {
  return evt.Event === 'PresenceStateChange';
}

export function isPresenceStateListComplete(evt: AMIEvent): evt is PresenceStateListComplete {
...
export function isQueueSummaryComplete(evt: AMIEvent): evt is QueueSummaryComplete {
...
export function isQueueMemberRinginuse(evt: AMIEvent): evt is QueueMemberRinginuse {
...
export function isRequestNotSupported(evt: AMIEvent): evt is RequestNotSupported {
...
export function isVoicemailPasswordChange(evt: AMIEvent): evt is VoicemailPasswordChange {
